...
- Otherwise identical to [v1.2.1](https://github.com/ZauJulio/ZeroWhats/releases/tag/v1.2.1) / [v1.2.0](https://github.com/ZauJulio/ZeroWhats/releases/tag/v1.2.0): auto-lock rewritten as a Rust-side idle watcher, fixed the notification app icon, and the completed Linux arm64 release matrix (deb/rpm/AppImage/Snap).
