...
a draft GitHub Release. The Snap and AUR jobs are best-effort and need their own
credentials:
...
> Snap builds from source inside a sandbox and may need path/runtime tweaks for
> your environment; the desktop matrix (deb/rpm/AppImage/msi/dmg) is the
